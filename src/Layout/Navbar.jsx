          ...
          <nav className='py-8'>
            <div className="container flex justify-between flex-wrap md:flex-nowrap gap-5">
                ...
                <div className='flex md:gap-10 gap-5  order-2 md:order-3' >
                   ...
                   <Link to="/login" className='flex items-center gap-1.5'><GoHeart className='text-xl' /><span className='hidden md:block'>Wishlist  </span></Link>
                   <Link to="/login" className='flex items-center gap-1.5'><GiShoppingCart className='text-2xl' /><span className='hidden md:block'> My Cart</span> <span className='bg-red-500 w-5 h-5 flex items-center rounded-full justify-center text-white'>1</span></Link>
